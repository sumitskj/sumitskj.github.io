...
function Hero() {
  return (
    ...
    >
      <div className="w-full text-center flex justify-center items-center text-3xl lg:text-6xl font-bold hello-anim">
        Hello
        <span className="wave-hand text-yellow-300 px-2">&#128075;</span>
        from,
      </div>
      <div className="pt-12 flex w-full text-black text-center justify-center items-center font-extrabold text-6xl lg:text-[14rem] whitespace-break-spaces">
        <div>
        ...
        <div className="pl-12 hide-papermill">
          <img
            src="./r.svg"
            className="rotate-papermill h-[60px] lg:h-[120px]"
          />
        </div>
      </div>
      <div className="delayed-caption flex justify-start items-center gap-2 pt-10">
        ...
        <div className="flex flex-col items-baseline justify-center font-medium">
          <div className="text-xl">{`Jack of all trades, master of none,`}</div>
          <div className="text-xl">{`Often better than master of one.`}</div>
        </div>
